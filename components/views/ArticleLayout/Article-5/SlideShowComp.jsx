    ...
    <div>
      {displaySingleImage ? (
        <div className="display-single-image-main">
          <div
            className="d-flex justify-content-end prp-2 cursor-pointer"
            onClick={() => setDisplaySingleImage(false)}
          >
          ...
          <div className="display-single-image-body">
            ...
            <div className="display-single-image-caption-btn">
              ...
              <div
                className="display-single-image-caption"
                dangerouslySetInnerHTML={{ __html: images[nextImage].title }}
              ></div>
              <div className="display-single-image-btn">
                <span
                  onClick={() => handlePrevious()}
                  className="prp-3 cursor-pointer"
                >
                  <AiOutlineArrowLeft />
                </span>
            ...
            {images.length > 6 ? (
              <div className="grid-of-3 ">
                {images.slice(0, 5).map((img, index) => (
                  <div
                    key={index}
                    className={`grid-temp grid-temp-${index} cursor-pointer`}
                    onClick={() => {
                ...
                <div className="grid-temp grid-temp-6">
                  ...
                  <div
                    className="grid-temp-6-fade cursor-pointer Biotif-SemiBold"
                    onClick={() => {
                      setDisplaySingleImage(true);
                      setNextImage(0);
                    }}
