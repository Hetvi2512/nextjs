    ...
    >
      <div className="row ma-0 row-data fullformat-2-card-3-web">
        {storyElement?.map((element,index) =>
          element.type === "text" ? (
            <div key={index} className="col-lg-6 col-xl-6 col-md-12 col-sm-12 p-0 d-flex align-center">
              <div
        ...
        {storyElement?.map((element, index) =>
          element.type === "image" ? (
            <div key={index} className="col-lg-6 col-xl-6 col-md-12 col-sm-12 a5-card3-img p-0 d-flex align-center">
              <div>
                <img
                  width="100%"
